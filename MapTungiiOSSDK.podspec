#
#  Be sure to run `pod spec lint MapTungiiOSSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/kramesh2005new/MapTungiiOSSDK"
  ...
  spec.source       = { :git => "https://github.com/kramesh2005new/MapTungiiOSSDK.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "MapTungiiOSSDK/**/*.{swift}"
  ...
  spec.resources = "MapTungiiOSSDK/**/*.{png,json,xib,html}"
